...
X_UnInt32 _grid_forming_inverter__averaged__controller_outer_voltage_loop___inner_current_loop_inner_current_control_loop_sum6__out;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _modbus1_modbus_device2__config1__comp_holding_out__out[4] = XIo_InFloat(0x55000174);
    _modbus1_modbus_device2__config1__comp_holding_out__out[5] = XIo_InFloat(0x55000178);
    _modbus1_modbus_device2__config1__comp_holding_out__out[6] = XIo_InFloat(0x5500017c);
    _modbus1_modbus_device2__config1__comp_holding_out__out[7] = XIo_InFloat(0x55000180);
    _modbus1_modbus_device2__config1__comp_holding_out__out[8] = XIo_InFloat(0x55000184);
    _modbus1_modbus_device2__config1__comp_holding_out__out[9] = XIo_InFloat(0x55000188);
    _modbus1_modbus_device2__config1__comp_holding_out__out[10] = XIo_InFloat(0x5500018c);
    _modbus1_modbus_device2__config1__comp_holding_out__out[11] = XIo_InFloat(0x55000190);
    ...
    XIo_OutFloat(0x55000194, _modbus1_c_u11__out);
    // Generated from the component: Modbus1.ModBus Device2 (config1).comp_discrete_in
    XIo_OutFloat(0x55000198, _modbus1_c_u12__out);
    // Generated from the component: Modbus1.ModBus Device2 (config1).comp_holding_in
    XIo_OutFloat(0x5500019c, _modbus1_c_u13__out);
    // Generated from the component: Modbus1.Product13
    _modbus1_product13__out = (_constant11__out * _modbus1_constant13__out);
    // Generated from the component: Modbus1.Product5
    _modbus1_product5__out = (_constant9__out * _modbus1_constant5__out);
    // Generated from the component: Modbus1.Product9
    _modbus1_product9__out = (_constant10__out * _modbus1_constant9__out);
    ...
    HIL_OutAO(0x404a, (float)_modbus1_product13__out);
    ...
    HIL_OutAO(0x4048, (float)_modbus1_product5__out);
    ...
    HIL_OutAO(0x4049, (float)_modbus1_product9__out);
    ...
    HIL_OutAO(0x4039, (float)_modbus1_c_function15__out);
    ...
    HIL_OutAO(0x403a, (float)_modbus1_c_function16__out);
    ...
    HIL_OutAO(0x403b, (float)_modbus1_c_function17__out);
    ...
    HIL_OutAO(0x403c, (float)_modbus1_c_function18__out);
    ...
    HIL_OutAO(0x4040, (float)_modbus1_c_function2__out);
    ...
    HIL_OutAO(0x4041, (float)_modbus1_c_function4__out);
    ...
    _grid_forming_inverter__averaged_2_controller_frequency_droop_sum1__out = _modbus1_product15__out - _grid_forming_inverter__averaged_2_controller_integrator2__out;
    // Generated from the component: Grid forming inverter (averaged)2.Controller.Voltage droop.Sum2
    _grid_forming_inverter__averaged_2_controller_voltage_droop_sum2__out = _modbus1_product16__out - _grid_forming_inverter__averaged_2_controller_integrator3__out;
    // Generated from the component: Grid forming inverter (averaged)3.Controller.Frequency droop.Sum1
    _grid_forming_inverter__averaged_3_controller_frequency_droop_sum1__out = _modbus1_product17__out - _grid_forming_inverter__averaged_3_controller_integrator2__out;
    // Generated from the component: Grid forming inverter (averaged)3.Controller.Voltage droop.Sum2
    _grid_forming_inverter__averaged_3_controller_voltage_droop_sum2__out = _modbus1_product18__out - _grid_forming_inverter__averaged_3_controller_integrator3__out;
    ...
    _modbus1_product7__out = (_grid_forming_inverter__averaged_2_controller_frequency_droop_sum1__out * _modbus1_constant7__out);
    ...
    _modbus1_product11__out = (_grid_forming_inverter__averaged_3_controller_frequency_droop_sum1__out * _modbus1_constant11__out);
    ...
    HIL_OutAO(0x403e, (float)_modbus1_product7__out);
    ...
    HIL_OutAO(0x403f, (float)_modbus1_product11__out);
    ...
    HIL_OutAO(0x403d, (float)_modbus1_product1__out);
    ...
    _modbus1_product8__out = (_measurement2_voltage_deviation__violation * _modbus1_constant8__out);
    // Generated from the component: Modbus1.Product12
    _modbus1_product12__out = (_measurement3_violation__violation * _modbus1_constant12__out);
    ...
    HIL_OutAO(0x4045, (float)_modbus1_product3__out);
    ...
    HIL_OutAO(0x4046, (float)_modbus1_product8__out);
    ...
    HIL_OutAO(0x4047, (float)_modbus1_product12__out);
    ...
    XIo_OutInt32(0x550001a0, _modbus1_bus_join2__out[0]);
    XIo_OutInt32(0x550001a4, _modbus1_bus_join2__out[1]);
    XIo_OutInt32(0x550001a8, _modbus1_bus_join2__out[2]);
    XIo_OutInt32(0x550001ac, _modbus1_bus_join2__out[3]);
    XIo_OutInt32(0x550001b0, _modbus1_bus_join2__out[4]);
    XIo_OutInt32(0x550001b4, _modbus1_bus_join2__out[5]);
    XIo_OutInt32(0x550001b8, _modbus1_bus_join2__out[6]);
    XIo_OutInt32(0x550001bc, _modbus1_bus_join2__out[7]);
    XIo_OutInt32(0x550001c0, _modbus1_bus_join2__out[8]);
    XIo_OutInt32(0x550001c4, _modbus1_bus_join2__out[9]);
    XIo_OutInt32(0x550001c8, _modbus1_bus_join2__out[10]);
    XIo_OutInt32(0x550001cc, _modbus1_bus_join2__out[11]);
    XIo_OutInt32(0x550001d0, _modbus1_bus_join2__out[12]);
    XIo_OutInt32(0x550001d4, _modbus1_bus_join2__out[13]);
    XIo_OutInt32(0x550001d8, _modbus1_bus_join2__out[14]);
    XIo_OutInt32(0x550001dc, _modbus1_bus_join2__out[15]);
    XIo_OutInt32(0x550001e0, _modbus1_bus_join2__out[16]);
    XIo_OutInt32(0x550001e4, _modbus1_bus_join2__out[17]);
    XIo_OutInt32(0x550001e8, _modbus1_bus_join2__out[18]);
    XIo_OutInt32(0x550001ec, _modbus1_bus_join2__out[19]);
    XIo_OutInt32(0x550001f0, _modbus1_bus_join2__out[20]);
    XIo_OutInt32(0x550001f4, _modbus1_bus_join2__out[21]);
    XIo_OutInt32(0x550001f8, _modbus1_bus_join2__out[22]);
    XIo_OutInt32(0x550001fc, _modbus1_bus_join2__out[23]);
