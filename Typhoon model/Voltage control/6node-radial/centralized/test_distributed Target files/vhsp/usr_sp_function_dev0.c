...
X_UnInt32 _grid_forming_inverter__averaged_2_controller_outer_voltage_loop___inner_current_loop_outer_voltage_control_loop_product8__out;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _modbus2_product6__out = (_measurement1_gain2__out * _modbus2_constant6__out);
    ...
    _modbus3_product6__out = (_measurement2_gain2__out * _modbus3_constant6__out);
    ...
    _modbus4_product6__out = (_measurement3_gain2__out * _modbus4_constant6__out);
