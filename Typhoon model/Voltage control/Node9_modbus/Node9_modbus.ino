...
void loop() {
  ...
  else 
  {
    if(a.isSynced())
    {
      ...
      deltaQ = a.voltageControl_dist(v_error0,1,5,0.5,q_level0,0.707,-0.707,-0.225736,1/3,20,200,0.001);
//voltageControl(deltaV,Vref,secPercentage,p,q_level0,qtop,qbottom,S,alphaVC,iterations,period,epsilon ) 
